...
- Changed database to MSSQL instead of SQLite.

## [2.2.1] - 2026-02-06

### Fixed

- Fixed bug when person has no SAP cases.

## [2.2.0] - 2025-12-10

### Changed

- Updated text and formatting of numbers in email.
...
- Bumped OpenOrchestrator to 2.0.0.
...
[2.2.0]: https://github.com/itk-dev-rpa/Forespoergsler-til-Ejendomsbeskatningen/releases/tag/2.2.0
